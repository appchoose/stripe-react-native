## API Report File for "@appchoose/stripe-react-native"
...
// @public
export const createPaymentMethodCustom: (params: PaymentMethod.CreateParams) => Promise<CreatePaymentMethodResult>;
...
// @public (undocumented)
export const getNetworksForCard: (params: {
    cardNumber: string;
...
// @public (undocumented)
export type PossibleBrand = 'visa' | 'amex' | 'mastercard' | 'discover' | 'jcb' | 'diners' | 'unionpay' | 'cartes_bancaires' | 'unknown';
...
// @public
export const scanCard: () => Promise<CardScanResult>;
...
// src/types/PaymentMethod.ts:310:3 - (ae-forgotten-export) The symbol "UserInterfaceStyle" needs to be exported by the entry point index.d.ts
